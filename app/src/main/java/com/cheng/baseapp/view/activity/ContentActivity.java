...
import com.cheng.baseapp.adapter.FragmentViewPagerAdapter;
import com.cheng.baseapp.api.Const;
import com.cheng.baseapp.bean.PersonInfoBean;
import com.cheng.baseapp.model.ContentModel;
import com.cheng.baseapp.util.BaseUtil;
import com.cheng.baseapp.view.fragment.BaseFragment;
import com.cheng.baseapp.view.fragment.InformationFragment;
import com.cheng.baseapp.view.fragment.QuotationFragment;
import com.cheng.baseapp.view.fragment.TransactionFragment;
import com.cheng.baseapp.view.widget.CircleImageView;
import com.cheng.baseapp.view.widget.NoScrollViewPager;
...
public class ContentActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        initVp();
//        System.out.println(AgentWebConfig.getCookiesByUrl("https://xueqiu.com"));
        initHint();
        initInfo();
        initPop();
        initListener();
    ...
    public void initHint(){
        mTvContentHint.setText("                                           股市有机遇，捞钱需胆识。祝财运················  ");
...
//        });
    ...
    private void initInfo() {
       if (BaseUtil.getSpBoolean(Const.IsLogin)){
           ...
           mTvMenuName.setText("AI");//用户姓名
           mTvMenuAccount.setText("三毛：");//账户名
