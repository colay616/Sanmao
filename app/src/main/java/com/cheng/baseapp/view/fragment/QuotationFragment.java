...
import com.cheng.baseapp.adapter.QuotationAdapter;
import com.cheng.baseapp.api.Const;
import com.cheng.baseapp.bean.QuotationBean;
import com.cheng.baseapp.model.QuotationModel;
import com.cheng.baseapp.service.QuotationService;
import com.cheng.baseapp.util.BaseUtil;
import com.cheng.baseapp.util.StringUtils;
import com.cheng.baseapp.view.activity.QuotationActivity;
    ...
    private void initSetting(){
        ...
        mAdapter.setonViewHolderClickListener(new BaseViewHolder.OnViewHolderClickListener<QuotationBean>() {
            ...
            public void onClick(BaseViewHolder holder, QuotationBean data, int position) {
                ...
                if (StringUtils.isEmpty(data.shares)){
...
//                intent.putExtra("goodsId",data.goodsId);
                intent.putExtra("shares",data.shares);
