...
//    public static final String URL_Quotation="https://spare.sjqcj.com/api/ballot/today?group=today";//获取行情数据
    public static final String URL_Quotation="https://spare.sjqcj.com/api/ballot/today?group=today";//获取行情数据
    ...
    public static final String URL_KChart="https://xueqiu.com/stock/forchartk/stocklist.json?type=before&begin=1478620800000&end=1510126200000&_=1510126200000";//K图数据
//&symbol=SH600756&period=1day
//        public static final String URL_KChart="http://money.finance.sina.com.cn/quotes_service/api/json_v2.php/CN_MarketData.getKLineData?datalen=210";//K图数据
